...
function HungerPacmanDemo() {
    new HungerPacmanSim();
}

class HungerPacmanSim extends CodeTrace {
    constructor() {
        super("HungerPacmanSim")
        let gw = this.installGWindow("PacmanHungerCanvas");
        this._gw = gw;
        this.reset();
